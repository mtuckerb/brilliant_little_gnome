...
mod tests {
    ...
    fn validation_probe_url_override_default_and_empty_host() {
        ...
        // Falls back to the host-derived whoami endpoint when unset.
        ...
        // Empty host with no override is an error, not a silent bad URL.
    ...
    async fn probe_session_inconclusive_on_unreachable() {
        // Bind then drop to obtain a port that is now closed.
        let addr = {
