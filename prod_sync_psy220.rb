...
db_path = "/Users/mtuckerb/Library/Application Support/Brilliant/db/production.sqlite3"
...
puts "Updating PRODUCTION database for PSY-220..."
...
all_ids.each do |obj_id|
  ...
  puts " - Saved: #{name} (#{displayed_grade})"
end
puts "Done."
